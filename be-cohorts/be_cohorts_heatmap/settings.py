"""
Django settings for be_cohorts_heatmap project.
...
SECRET_KEY = 'django-insecure-b#_7c&1ths^p6py$5bk#c6tyqw(xmwjq!5!n_+6&b6+p&w-0@r'
...
ROOT_URLCONF = 'be_cohorts_heatmap.urls'
...
WSGI_APPLICATION = 'be_cohorts_heatmap.wsgi.application'
